...
Game.prototype.switchTurn = function () {
	...
	game.turn =
		game.turn == Config.HUMAN_PLAYER ? Config.COMPUTER_AI : Config.HUMAN_PLAYER;
	...
	if (
		isDrawn ||
		score > Config.WINNING_SCORE - 100 ||
		score < -Config.WINNING_SCORE + 100
	) {
		$("#winningAlert").show();
		$("#scoreAlert").hide();
		$("#waitingAlert").hide();
		document.getElementById("winningAlert").innerHTML = isDrawn
			? "The game is drawn!"
			: score > 0
			? "You Win!"
			: "AI Wins!";
